...
export const uslugi: any = {
  ...
  content: [
    ...
    },
    {
      id: 3,
      icon: <Reload />,
      title: `Модернизация или ремонт \nсуществующей системы`,
      text: ``,
    },
    {
      id: 4,
      icon: <Date />,
      title: `Регулярное техническое \nобслуживание`,
      text: ``,
    },
  ],
};
...
export const pozharnyeSistemy: any = {
  ...
  content: [
    ...
    },
    {
      ...
      title: `Автоматика противодымной \nвентиляции.`,
      text: ``,
      href: '',
      target: '',
    },
...
export const ohrannyeSistemy: any = {
  ...
  content: [
    ...
    },
    {
      ...
      text: ``,
      href: 'https://orionsb.ru/oxrannye-sistemy/',
      target: '_blank',
    },
    {
      id: 3,
  ...
  content: [
    {
      ...
      text: 'Бесплатный выезд инженера на объект и расчет стоимости работ в течении 24 часов с момента заявки.',
    },
    {
      id: 2,
      icon: <Coin />,
      title: `Низкие цены`,
      text: `До 20% экономии на оборудовании благодаря прямым закупкам у производителя.`,
    },
    {
      id: 3,
      icon: <Like />,
      title: `Успешный опыт`,
      text: `Успешный опыт работы свыше 12 лет на объектах разного уровня.`,
    },
    {
      id: 4,
      icon: <Rocket />,
      title: `Современные технологии`,
      text: `Использование новейшего оборудования и современных технологий.`,
    },
    {
      id: 5,
      icon: <Date />,
      title: `Соблюдение сроков`,
      text: `Соблюдение сроков выполнения работ зафиксированных в договоре`,
    },
    {
      id: 6,
      icon: <Secure />,
      title: `Гарантийное обслуживание`,
      text: `Гарантийное и постгарантийное обслуживание на спец. условиях.`,
    },
  ],
};
  ...
  content: [
    {
      id: 1,
      image: num1,
      title: `Услугу под ключ`,
      text: 'Проектирование, поставку оборудования, монтажные работы и полный комплект документов от одной компании.',
    },
    {
      id: 2,
      image: num2,
      title: `Рабочую систему`,
      text: `Полностью работоспособную систему, смонтированную согласно действующим нормам и правилам пожарной безопасности.`,
    },
    {
      id: 3,
      image: num3,
      title: `Комплект документов`,
      text: `Необходимый для эксплуатации системы, и успешного прохождения проверок МЧС.`,
    },
    {
      id: 4,
      image: num4,
      title: `Экономию бюджета`,
      text: `Мы предложим Вам наиболее оптимальный вариант оборудования и работ исходя из особенностей вашего объекта.`,
    },
    {
      id: 5,
      image: num5,
      title: `Качественный монтаж`,
      text: `Наши монтажники не задевают интерьер и коммуникации, и не оставляют после себя мусор.`,
    },
    {
      id: 6,
      image: num6,
      title: `Бесплатное обучение`,
      text: `Наши специалисты проведут обучение вашего персонала по эксплуатации установленной системы.`,
    },
  ],
};
  ...
  content: [
    {
      id: 1,
      image: dop1,
      title: `Рассчитать и поставить на объект необходимое количество противопожарного оборудования (огнетушители, пожарные щиты и т.д.)`,
      href: '',
      target: '',
    },
    {
      id: 3,
      image: dop3,
      title: `Выполнить проверку и испытание пожарных кранов (ПК), выполнить перекатку пожарных рукавов.`,
      href: '',
      target: '',
    },
    {
      id: 2,
      image: dop2,
      title: `Провести испытания пожарных лестниц и ограждений.`,
      href: '',
      target: '',
    },

    {
      id: 4,
      image: dop4,
      title: `Разработать и изготовить планы эвакуации. Поставить знаки пожарной безопасности.`,
      href: '',
      target: '',
    },
  ],
